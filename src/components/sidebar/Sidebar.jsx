    ...
    return (
        <>
            ...
            <aside className={`
                ...
                <div className="flex justify-center items-center w-full h-13 gap-1 bg-sky-900 text-white">
                    <div className="flex items-center justify-center p-2 rounded-3xl w-1/2 hover:text-black hover:bg-yellow-400 transition-colors duration-300 cursor-pointer gap-1">
                        <p>Telefones</p>
